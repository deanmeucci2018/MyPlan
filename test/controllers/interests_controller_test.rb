...
class InterestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create interest" do
    assert_difference('Interest.count') do
      post interests_url, params: { interest: { department_id: @interest.department_id, interest_name: @interest.interest_name, interest_type: @interest.interest_type, total_credits_needed: @interest.total_credits_needed } }
    end
  ...
  test "should update interest" do
    patch interest_url(@interest), params: { interest: { department_id: @interest.department_id, interest_name: @interest.interest_name, interest_type: @interest.interest_type, total_credits_needed: @interest.total_credits_needed } }
