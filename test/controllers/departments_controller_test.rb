...
class DepartmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create department" do
    assert_difference('Department.count') do
      post departments_url, params: { department: { dep_full_name: @department.dep_full_name, dep_short_name: @department.dep_short_name } }
    end
  ...
  test "should update department" do
    patch department_url(@department), params: { department: { dep_full_name: @department.dep_full_name, dep_short_name: @department.dep_short_name } }
