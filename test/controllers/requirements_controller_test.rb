...
class RequirementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create requirement" do
    assert_difference('Requirement.count') do
      post requirements_url, params: { requirement: { courses_towards_requirement: @requirement.courses_towards_requirement, interest_id: @requirement.interest_id, requirement_name: @requirement.requirement_name, requirement_type: @requirement.requirement_type } }
    end
  ...
  test "should update requirement" do
    patch requirement_url(@requirement), params: { requirement: { courses_towards_requirement: @requirement.courses_towards_requirement, interest_id: @requirement.interest_id, requirement_name: @requirement.requirement_name, requirement_type: @requirement.requirement_type } }
